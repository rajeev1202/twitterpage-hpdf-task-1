It is a small Project in which two Twitter webpages  have been cloned 

One is  Main timeline: https://twitter.com  and 

Other one is  Search results: https://twitter.com/search?q=aadhaar

These two cloned webpages are build using [Reactjs](https://reactjs.org/docs/forms.html) and [Material-UI](http://www.material-ui.com/#/)

**Running the app locally**
```
git clone https://github.com/rajeev1202/twitterpage-hpdf-task-1
cd twitterpage-hpdf-task-1
npm install
```
...
If you have ideas for more “How To” recipes that should be on this page or  if you find a bug, [let me know](https://github.com/rajeev1202/twitterpage-hpdf-task-1/issues) 
